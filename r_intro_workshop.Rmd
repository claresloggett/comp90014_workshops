...
plot(data$counts, data$sizes)
plot(data$counts, data$gc)
```

The `lm()` function will return a data structure containing the results of the fit, including the coefficients. 
