...
* Run a simple statistical analysis using R (linear regression)
...
* Username a-c: http://comp90014-a.genome.edu.au/rstudio 
* Username d-k: http://comp90014-b.genome.edu.au/rstudio 
* Username l-t: http://comp90014-c.genome.edu.au/rstudio 
* Username u-z: http://comp90014-d.genome.edu.au/rstudio 
...
We are going to install the limma library, which has functions for differential gene expression analysis for both microarray and RNA-seq data. The usual way to install a library into R is with the `install.packages()` function. For Bioconductor packages there is a special method:
...
If you are asked if you wish to use a personal library, answer yes. This installs limma in your private version of RStudio.
